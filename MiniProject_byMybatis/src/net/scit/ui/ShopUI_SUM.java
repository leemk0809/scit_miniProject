...
public class ShopUI_SUM {
	...
	private void login() {
		String choice = loginMenu();
		
		if(choice == null) return;
		
		if(choice.equals("userMenu")) userMenu();
		else if(choice.equals("adminMenu")) adminMenu();
		else return;
	...
	public String loginMenu() {
		...
		if (usrid.equals(udao.selectOneUser("admin").getUsrid())) {
			return "adminMenu";
		} else {
			return "userMenu";
		}
	...
	*/
	...
	private void categoryList() {
		...
		while (iter.hasNext())
			System.out.println(iter.next().printList());
	}
